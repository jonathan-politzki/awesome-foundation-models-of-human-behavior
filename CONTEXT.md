...
- [Large language models can predict the results of social science experiments](https://www.nature.com/articles/s41586-026-10742-x) · Hewitt, Ashokkumar, Ghezae & Willer, Nature 2026 (preprint 2024). GPT-4-simulated responses predict 476 treatment effects across 70 preregistered US survey experiments (105,165 participants) at r = 0.85, equaling or exceeding human expert forecasters; accuracy holds at r = 0.90 on unpublished studies absent from training data ([demo](https://treatmenteffect.app)).
