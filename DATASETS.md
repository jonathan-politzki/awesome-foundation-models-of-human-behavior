...
| **[ToolSandbox](https://arxiv.org/abs/2504.04537)** | tool-use task success inside interactive loops that embed an LLM user simulator | synthetic key (tool-use task success) | thin as human-fidelity evidence: the target is agent tool-use correctness, not the simulator's fidelity to a real person |
